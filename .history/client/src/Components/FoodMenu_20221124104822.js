        ...
        <Menu>
          {({ isOpen }) => (
            <>
              ...
              <MenuList>
                <MenuItem onClick={() => updateMenu('Cafe 3', 'Breakfast')}>Breakfast</MenuItem>
                <MenuItem onClick={() => updateMenu('Clark Kerr', 'Lunch')}>Lunch</MenuItem>
                <MenuItem onClick={() => updateMenu('Crossroads', 'Dinner')}>Dinner</MenuItem>
              </MenuList>
            </>
          )}
        </Menu>
