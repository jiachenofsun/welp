...
function Navbar() {
    ...
    return (
      <div style={{ display: "flex", alignSelf: "flex-end", width: "100%", paddingTop:20, paddingBottom: 20, borderBottom: "solid gray 1px"}}>
        ...
        <div style={{marginLeft: 5, marginTop:30}}>Yelp for Cal Dining</div>
        <button style={{right:0, marginLeft:"auto", marginRight:30, fontSize: 17}} onClick={() => window.location.href='./about.html'}>About</button>
